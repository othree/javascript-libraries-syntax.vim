...
if &filetype == 'coffee'
  syntax match   coffeeMethods /\.\h\w\*(\@=/   containedin=ALL contains=@coffeeLibraryFuncs
  syntax match   coffeeMethods /\.\h\w\* [0-9A-Za-z_(\[{]\@=/ containedin=ALL contains=@coffeeLibraryFuncs
endif
