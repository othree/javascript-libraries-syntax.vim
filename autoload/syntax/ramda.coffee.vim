...
syntax match   coffeeRaDot      /\./ nextgroup=@coffeeRaaFunctions
syntax keyword coffeeRamda      R containedin=ALLBUT,coffeeComment,coffeeLineComment,coffeeString,coffeeTemplate,coffeeTemplateSubstitution nextgroup=coffeeRaDot
