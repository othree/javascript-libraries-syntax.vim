...
syntax match   typescriptRaDot      contained /\./ nextgroup=@typescriptRaaFunctions
syntax keyword typescriptRamda      R containedin=ALLBUT,typescriptComment,typescriptLineComment,typescriptString,typescriptTemplate,typescriptTemplateSubstitution nextgroup=typescriptRaDot
