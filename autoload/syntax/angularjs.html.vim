...
syntax keyword  htmlArg contained ng-mouseover ng-mouseup ng-multiple ng-non-bindable ng-options ng-pluralize ng-readonly
...
syntax match    htmlArg contained /\(ng_\|ng:\|x-ng-\)\(mouseover\|mouseup\|multiple\|non-bindable\|options\|pluralize\|readonly\)/
