...
syntax keyword  htmlArg contained ng-keyup ng-list ng-model ng-mousedown ng-mouseenter ng-mouseleave ng-mousemove
...
syntax match    htmlArg contained /\(ng_\|ng:\|x-ng-\)\(keyup\|list\|model\|mousedown\|mouseenter\|mouseleave\|mousemove\)/
