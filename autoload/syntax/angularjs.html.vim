...
syntax keyword  htmlArg contained ng-repeat ng-required ng-selected ng-show ng-src ng-style ng-submit ng-switch ng-switch-when
...
syntax match    htmlArg contained /\(ng_\|ng:\|x-ng-\)\(repeat\|required\|selected\|show\|src\|style\|submit\|switch\|switch-when\)/
